define(['jquery','underscore','backbone','handlebars', 'handlebarshelpers', 'jquery.cookie', 'utilities',
        '/payment-portlet/js/tabcontent.js',
        '/payment-portlet/modules/models/payment.js',
        '/payment-portlet/modules/models/createOrder.js',
        '/payment-portlet/modules/models/validateCartOnPayment.js',
        '/payment-portlet/modules/models/orderSummary.js',
        '/payment-portlet/modules/templates/payment.js',
        '/after-sales-portlet/modules/templates/orderconfirmation.js',
        '/order-summary-portlet/modules/templates/ordersummary.js'
        ], 
  function ($, _, Backbone, Handlebars, handlebarshelpers, jCookie, utilities, tabcontent, Payment, CreateOrder, ValidateCartOnPayment, OrderSummary) {
  'use strict';
