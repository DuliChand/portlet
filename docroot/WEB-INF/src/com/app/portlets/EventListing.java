...
/**
 * EventListingPortlet class represents the portlet class responsible for
 * generating navigation bar in page.
 * 
 * @author webshop-team
 */
public class EventListing extends MVCPortlet {

	private Logger logger = Logger.getLogger(EventListing.class);
	...
	public void doView(RenderRequest request, RenderResponse response)
		...
		try {
			...
			logger.error(
					"Exception while executing EventListingPortlet doView()",
					ex);
		}
		...
		String categoryEventData = RestUtil.getResponsefromURL(requestURL);

		request.setAttribute("categoryEventData", categoryEventData);
		...
		portletSession.setAttribute("sectionType", sectionType,
				PortletSession.APPLICATION_SCOPE);
